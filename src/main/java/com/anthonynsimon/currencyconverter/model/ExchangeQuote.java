...
public class ExchangeQuote {
    ...
    private ExchangeQuote(Currency fromCurrency, Currency toCurrency, BigDecimal amountToConvert, BigDecimal conversionResult) {
    ...
    public static class Builder {
        ...
        public ExchangeQuote build() {
            return new ExchangeQuote(fromCurrency, toCurrency, amountToConvert, conversionResult);
        }
    }
}
